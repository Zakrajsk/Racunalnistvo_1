...
class Zavetisce():
    ...
    def oddaj_zival(self):
        ...
        return self.oddaj_psa() if self._psi.zacetek()[1] < self._macki.zacetek()[1] else self.oddaj_macko()
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjE3MH0:1iL2wV:gmhEV_lgiowKCjobAF0-ZSaDoy8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjE3MX0:1iL2wV:NrbJR1nHQGGV1KHAwv6t4KaFWDU'
        try:
