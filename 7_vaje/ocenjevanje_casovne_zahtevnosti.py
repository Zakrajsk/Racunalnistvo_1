...
zahtevnosti4 = ('O(n)', 'O(n)', 'O(log n)', 'O(log n)',  'O(n log n)')
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc2NCwidXNlciI6MjA5OX0:1iaHmN:vXYAcdMU_NIqdu4VbM1FAOc8H5Y'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc2NSwidXNlciI6MjA5OX0:1iaHmN:_HJrVCiIOwbxhtSodhj8IXO1gU8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc2NiwidXNlciI6MjA5OX0:1iaHmN:BG8ajkv_p4Cg16DUXOL7yEc108M'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc2NywidXNlciI6MjA5OX0:1iaHmN:hksYgfejSGJ6D_UEXefWue0nR_g'
        try:
