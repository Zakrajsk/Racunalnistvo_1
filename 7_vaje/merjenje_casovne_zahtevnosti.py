...
povp_cas_f1a_10 = timeit.timeit('f1a(10)', globals=globals(), number=5)
povp_cas_f1a_30 = timeit.timeit('f1a(30)', globals=globals(), number=5)
print(povp_cas_f1a_30 / povp_cas_f1a_10)

povp_cas_f1b_10 = timeit.timeit('f1b(10)', globals=globals(), number=5)
povp_cas_f1b_30 = timeit.timeit('f1b(30)', globals=globals(), number=5)
print(povp_cas_f1b_30 / povp_cas_f1b_10)

povp_cas_f1c_10 = timeit.timeit('f1c(10)', globals=globals(), number=5)
povp_cas_f1c_30 = timeit.timeit('f1c(30)', globals=globals(), number=5)
print(povp_cas_f1c_30 / povp_cas_f1c_10)

povp_cas_f1d_10 = timeit.timeit('f1d(10)', globals=globals(), number=5)
povp_cas_f1d_30 = timeit.timeit('f1d(30)', globals=globals(), number=5)
print(povp_cas_f1d_30 / povp_cas_f1d_10)

povp_cas_f1e_10 = timeit.timeit('f1e(10)', globals=globals(), number=5)
povp_cas_f1e_30 = timeit.timeit('f1e(30)', globals=globals(), number=5)
print(povp_cas_f1e_30 / povp_cas_f1e_10)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc2OCwidXNlciI6MjA5OX0:1iaHRm:cmC4UDSRSPEuNq-dOYHRnTqgEZI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc2OSwidXNlciI6MjA5OX0:1iaHRm:4Q9-VL2-jQ5IwIk_FJ2g64yv0iA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjc3MCwidXNlciI6MjA5OX0:1iaHRm:nLyF7zJC5NBy1tG1YpCFsw6_pF4'
        try:
