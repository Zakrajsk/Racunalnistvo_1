...
#     30
# =============================================================================
from drevo_mafija import Drevo
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjMwNSwidXNlciI6MjA5OX0:1iVCfd:0W1ch6M-F9afYOmvCGLBZP7V8bY'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjMwNiwidXNlciI6MjA5OX0:1iVCfd:gyP-0KeYrgmdsDcAT3Eg3Wik0Sg'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMjMwNywidXNlciI6MjA5OX0:1iVCfd:b-KUSVvx9HNkkYyrUndZEIZCQqs'
        try:
            test_data = [
