...
def preveri(s):
    """funckija preveri, ali je podan parameter seznam parov"""
    if s == list() or s[0] != (0, 0):
        return False
...
def sestaviZ(s, predmet):
    """Funkcija sestavi in vrne mnozica Zi+1"""
    return [(el[0] + predmet[0], el[1] + predmet[1]) for el in s]
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4MCwidXNlciI6MjA5OX0:1iha2S:Da2krX__dJLTP7O-6vnQEWdEvT0'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4MSwidXNlciI6MjA5OX0:1iha2S:j3_Z7p67Z2s8op0_-saFNsgLryw'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4MiwidXNlciI6MjA5OX0:1iha2S:lOqoWI3k354lt9IOi5K9Bj7Xk6M'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4MywidXNlciI6MjA5OX0:1iha2S:Dx4OUIqmwZWY_qNaja1uq2-B7UI'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4NCwidXNlciI6MjA5OX0:1iha2S:AzY57sLeczw91BpUFe8SR4Tcz-0'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4NSwidXNlciI6MjA5OX0:1iha2S:gDO1hDe_sfgbPwQ90vvlWpnUs7k'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4NiwidXNlciI6MjA5OX0:1iha2S:QS2xR_WPoQeAB_Hcgm1yHoNSNoU'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE4NywidXNlciI6MjA5OX0:1iha2S:nlWjCqKKdu1Rr87iWg2GwLBZapY'
        try:
            test_data = [
