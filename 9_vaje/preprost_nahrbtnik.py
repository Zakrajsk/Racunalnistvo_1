...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzE3OSwidXNlciI6MjA5OX0:1iha0V:_VE4BFbP3I5UlXUxXtvdhtXd-H4'
        try:
            test_data = [
                ('nahrbtnik([(30,57),(27,60),(35,105),(40,113),(50,100),(51,108)], 60)', [0,0,1,0.625,0,0]),
                ('nahrbtnik([(30,57),(27,60),(35,105),(40,113),(50,100),(51,108)], 75)', [0,0,1,1,0,0]),
                ('nahrbtnik([(30,57),(27,60),(35,105),(40,113),(50,100),(51,108)], 102)', [0,1,1,1,0,0]),
                ('nahrbtnik([(30,57),(27,60),(35,105),(40,113),(50,100),(51,108)], 153)', [0,1,1,1,0,1]),
                ('nahrbtnik([(30,57),(27,60),(35,105),(40,113),(50,100),(51,108)], 158)', [0,1,1,1,0.1,1]),
                ('nahrbtnik([(30,57),(27,60),(35,105),(40,113),(50,100),(51,108)], 500)', [1,1,1,1,1,1]),
            ]
