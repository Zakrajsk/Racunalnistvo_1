...
#     [3, 4, 5, 6, 7]
# =============================================================================
from veriga_vozlov import dodaj_na_zacetek, vrni_seznam, iz_seznama
...
# vozel ter vrne dve verigi, ki jih dobi tako, da v eno zloži vozle, ki vsebujejo
...
# =============================================================================
def sodi_in_lihi(v):
    """Vrne dve verigi, ena veriga vsebuje vse sode podatko druga pa vse lihe"""
    sode = None
    lihe = None
    for el in reversed(vrni_seznam(v)):
        if el % 2 == 0:
            sode = dodaj_na_zacetek(sode, el)
        else:
            lihe = dodaj_na_zacetek(lihe, el)
    return sode, lihe

# =====================================================================@022048=
# 3. podnaloga
# Sestavite funkcijo `podvoji_verigo(prvi)`, ki naj sestavi in
# vrne novo, identično kopijo verige, stare pa naj ne spreminja. Zgled:
# 
...
def stakni_verigi(v1, v2):
    """stakni verigi v1 in v2 in vrne referenco na prvi element v novi vrsti"""
...
import json, os, re, shutil, traceback, urllib.error, urllib.request
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjA0Nn0:1iNEXf:edX5s_9Obblw1SiR_ou4-pcg2AY'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjA0N30:1iNEXf:dg-XRGRbgQ6jsyTy1azYEmnhjTU'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1, 3, 4, 9, 8])",
                  "v1, v2 = sodi_in_lihi(v)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjA0OH0:1iNEXf:OBQRrwb6idGG3JPRyy98fUlBvv8'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjA0OX0:1iNEXf:7Y_jis-mq5uyID5q-tk72cKCAj4'
        try:
            test_data = [
                (["v1 = iz_seznama([1, 2, 3])",
                  "v2 = iz_seznama([4, 5, 6])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjA1MH0:1iNEXf:YGQGxCdz-698vtD9dTo7AM-MZmM'
        try:
            test_data = [
                (["v1 = iz_seznama([7, 5, 2])",
                  "v2 = iz_seznama([1, 3, 4, 9, 8])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMjA1MX0:1iNEXf:CXg9Fdppshk-1rMXD_xbHHVqljk'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1, 3, 4, 9, 8])",
                  "v1, v2 = odpni_zadrgo(v)",
