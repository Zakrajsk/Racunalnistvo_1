...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzM0MywidXNlciI6MjA5OX0:1ihu41:IwbZ6IX-NzZtFwAf3XinyX0aJ8c'
        try:
            Check.equal('stevilo_mnozenj([(30, 35), (35, 15), (15, 10), (10, 5), (5, 10)])', 10125)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])

    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMzM0NCwidXNlciI6MjA5OX0:1ihu41:PwdSrWDVgDlyusIpZpmpbQk6T-8'
        try:
            Check.equal('vrstni_red([(30, 35), (35, 15), (15, 10), (10, 5), (5, 10)])', '((A1(A2(A3A4)))A5)')
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
