...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMTg3MH0:1iIWlO:bUL5God_VwqILxQQSUVfMFdScIU'
        try:
            test_data = [
                ("vagoni('321', '312')", True),
            ...
            Check.secret(vagoni('87654321', '85437621'))
            Check.secret(vagoni('87654321', '12673458'))
        except:
