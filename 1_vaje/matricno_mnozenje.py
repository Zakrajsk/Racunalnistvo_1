...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMTg2NX0:1iJxhO:9HI79ByJvnYfWPW30U0UAu1YPxI'
        try:
            test_data = [
            ...
            Check.secret(stevilo_mnozenj('((A((CC)B))((CA)C))', {'A': (13, 13), 'B': (13, 20), 'C': (13, 13)}))
            Check.secret(stevilo_mnozenj('(((AB)C)(CD))', {'A': (12, 7), 'B': (7, 19), 'C': (19, 19), 'D': (19,10)}))
        except:
