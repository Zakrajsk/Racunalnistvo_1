...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMTg0MH0:1iIVKa:Nfa8mbJxj6rluHFFi43Twoq51u0'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """for i in range(10):""",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMTg0MX0:1iIVKa:A18le4u0V_DeXyLPurE-l9rUujc'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """for i in range(10):""",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyMDk5LCJwYXJ0IjoyMTg0Mn0:1iIVKa:pMlBf68dHjXxnyI4RMup-QKyNR8'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """for i in range(10):""",
